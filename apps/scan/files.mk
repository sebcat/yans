scan_DEPS     = lib/net/dsts.c lib/net/ip.c lib/net/ports.c \
                ...
                lib/util/csv.c lib/util/idset.c lib/util/io.c \
                lib/util/lines.c lib/util/netstring.c lib/util/reorder.c \
                lib/util/sandbox.c lib/util/str.c lib/util/zfile.c \
                lib/ycl/resolvercli.c lib/ycl/storecli.c lib/ycl/ycl_msg.c \
                lib/ycl/ycl.c
